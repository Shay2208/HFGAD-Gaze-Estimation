...
def main(train, test):
    ...
    for saveiter in range(1):
        ...
        statedict = torch.load(os.path.join(base_dir, 'evaluation', 'gaze360', 'checkpoint', 'ours_10.46.pt'))


        net.cuda(); net.load_state_dict(statedict, strict=True); net.eval()
