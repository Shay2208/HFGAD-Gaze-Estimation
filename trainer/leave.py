...
from models import Gaze, model, resnet
...
def main(config):
    ...
    # HFGAD decoder on top of a ResNet-18 encoder (the setting used in the paper).
    net = Gaze.GazeModel()
    # net = model.Model()      # GazeTR-style transformer baseline
    # net = resnet.Model()     # plain ResNet baseline
    net.train(); net.cuda()
